...
def main():
	...
	optional.add_argument('--addprefix', help='Add clone and haplotype numbers as a prefix to read names', action='store_false')	
	...
	molecules.add_argument('--molecules_coverage', help='Mean coverage per molecule [0.2]', default=0.2, type=float, metavar='')

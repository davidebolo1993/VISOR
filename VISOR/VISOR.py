...
def main():
	...
	badread.add_argument('--distribution', help='sequencing identity beta distribution or normal qscore distribution [beta]', metavar='', default='beta', choices=['beta', 'normal'])
	badread.add_argument('--identity_mean', help='mean sequencing identity for beta distribution [95.0]', metavar='', default=95.0, type=float)
	badread.add_argument('--identity_max', help='maximum sequencing identity for beta distribution [99.0]', metavar='', default=99.0, type=float)
	badread.add_argument('--identity_stdev', help='stdev of sequencing identity for beta distribution [2.5]', metavar='', default=2.5, type=float)
	badread.add_argument('--qscore_mean', help='mean qscore for normal distribution [20.0]', metavar='', default=20.0, type=float)
	badread.add_argument('--qscore_stdev', help='stdev of qscore for normal distribution [4.0]', metavar='', default=4.0, type=float)

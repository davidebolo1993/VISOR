...
echo "Downloading scripts from VISOR git"
...
VISOR SHORtS -g chr22.fa -s hetdup/Templates -bed files/hetdup/VISOR.sim.bed -c 1 -t single-strand -n 5.0 -o hetdup/Results -th 7
...
VISOR SHORtS -g chr22.fa -s hetdel/Templates -bed files/hetdel/VISOR.sim.bed -c 1 -t single-strand -n 5.0 -o hetdel/Results -th 7
...
VISOR SHORtS -g chr22.fa -s hetinv/Templates -bed files/hetinv/VISOR.sim.bed -c 1 -t single-strand -n 5.0 -o hetinv/Results -th 7
...
VISOR SHORtS -g chr22.fa -s hetinvdup/Templates -bed files/hetinvdup/VISOR.sim.bed -c 1 -t single-strand -n 5.0 -o hetinvdup/Results -th 7
...
VISOR SHORtS -g chr11_22.fa -s transloc/Templates -bed files/transloc/VISOR.sim.bed -c 1 -t single-strand -n 5.0 -o transloc/Results -th 7
...
VISOR SHORtS -g chr22.fa -s SCE/Templates -bed files/SCE/VISOR.sim.bed -c 1 -t single-strand -n 5.0 -scebed files/SCE/VISOR.h1.SCE.bed -o SCE/Results -th 7

...
- sim.bed is the .bed file containing region to simulate from h1.fa and h2.fa like the one in _Examples/SHORtS.LASeR.bed_. If multiple regions are given, the .bam files generated for each region will then be merged.

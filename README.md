...
- bedh1.bed is the .bed file containing variants to insert in haplotype 1 (required), like the one in _Examples/HACk.example.bed_
- bedh2.bed is the .bed file containing variants to insert in on haplotype 2 (optional)
...
- bedh1.bed is the .bed file containing regions to simulate from h1.fa, like the one in _Examples/SHORtS.LASeR.example.bed_
- bedh2.bed is the .bed file containing regions to simulate from h2.fa

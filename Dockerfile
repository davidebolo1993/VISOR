...
RUN conda install -y -n visorenv -c bioconda samtools wgsim pbsim bwa minimap2 pybedtools pysam pyfaidx
RUN conda install -y -n visorenv -c r r
RUN conda install -y -n visorenv -c bioconda bioconductor-rhtslib
